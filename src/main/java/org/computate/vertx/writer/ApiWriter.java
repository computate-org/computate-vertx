...
public class ApiWriter extends ApiWriterGen<Object> implements Comparable<ApiWriter> {
  ...
  protected void _classApiTag(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeApiTag_%s_stored_string", languageName)));
  }
  ...
  protected void _classSimpleName(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeNomSimple_%s_stored_string", languageName)));
  }
  ...
  protected void _classRoleUserMethod(Wrap<Boolean> c) {
    c.o(BooleanUtils.isTrue((Boolean)classSolrDocument.get(String.format("classeRoleUtilisateur%s_%s_stored_boolean", classApiMethod, languageName))));
  }

  protected void _classApiMethodMethod(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeApiMethode%s_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classApiMediaTypeRequestMethod(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeApiTypeMediaRequete%s_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classApiMediaType200Method(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeApiTypeMedia200%s_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classApiOperationIdMethod(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeApiOperationId%s_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classApiOperationIdMethodRequest(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeApiOperationId%sRequete_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classApiOperationIdMethodResponse(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeApiOperationId%sReponse_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classSuperApiOperationIdMethodRequest(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeSuperApiOperationId%sRequete_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classSuperApiOperationIdMethodResponse(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classeSuperApiOperationId%sReponse_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classPageCanonicalNameMethod(Wrap<String> c) {
    c.o((String)classSolrDocument.get(String.format("classePageNomCanonique%s_%s_stored_string", classApiMethod, languageName)));
  }

  protected void _classPageWithTemplateMethod(Wrap<Boolean> w) {
    w.o(BooleanUtils.isTrue(classSolrDocument.get("classePageAvecTemplate" + classApiMethod + "_stored_boolean")));
  }
  ...
  public void  initEntity(SolrResponse.Doc entitySolrDocument) {
    ...
    entityVar = (String)entitySolrDocument.get(String.format("entiteVar_%s_stored_string", languageName));
    entityVarCapitalized = (String)entitySolrDocument.get(String.format("entiteVarCapitalise_%s_stored_string", languageName));
    ...
    entityCanonicalNameGeneric = (String)entitySolrDocument.get(String.format("entiteNomCanoniqueGenerique_%s_stored_string", languageName));
    entityCanonicalName = (String)entitySolrDocument.get(String.format("entiteNomCanonique_%s_stored_string", languageName));
  ...
  public void  writeEntitySchema(Integer numberTabs, AllWriter w, String apiRequestOrResponse) throws Exception, Exception {
    numberTabs = numberTabs == null ? ((classPageWithTemplateMethod || classApiMethod.contains("Search")) && "response".equals(apiRequestOrResponse) ? 3 : ("PUT".equals(classApiMethodMethod) ? 3 : 0)) : numberTabs;
  ...
  public String toString() {
    return (String)classSolrDocument.get(String.format("classSimpleName_%s_stored_string", languageName)) + " " + classApiMethod;
  }
}
