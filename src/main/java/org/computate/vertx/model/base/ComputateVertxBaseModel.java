 ...
 */
public class ComputateVertxBaseModel extends ComputateVertxBaseModelGen<Object> {
	...
	protected void _classCanonicalNames(List<String> l) { 
		Class<?> cl = getClass();
		if(!cl.equals(ComputateVertxBaseModel.class))
			l.add(cl.getCanonicalName());
		l.add(ComputateVertxBaseModel.class.getCanonicalName());
	}
