//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// MODIFIED BY computate FROM THE ORIGINAL vertx-web SOURCE CODE                                            //
// I distribute, all copyright, patent, trademark, and attribution notices from the Source form of the Work //
// The OAuth2AuthHandlerImpl class and constructors renamed ComputateOAuth2AuthHandlerImpl                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
 * 
...
import io.vertx.ext.web.handler.impl.HTTPAuthorizationHandler.Type;
...
public class ComputateOAuth2AuthHandlerImpl extends HTTPAuthorizationHandler<OAuth2Auth> implements OAuth2AuthHandler, ScopedAuthentication<OAuth2AuthHandler>, OrderListener {
  ...
  public ComputateOAuth2AuthHandlerImpl(Vertx vertx, OAuth2Auth authProvider, String callbackURL) {
    this(vertx, authProvider, callbackURL, null);
  }

  public ComputateOAuth2AuthHandlerImpl(Vertx vertx, OAuth2Auth authProvider, String callbackURL, String realm) {
  ...
  private ComputateOAuth2AuthHandlerImpl(ComputateOAuth2AuthHandlerImpl base, List<String> scopes) {
  ...
  public OAuth2AuthHandler withScope(String scope) {
    ...
    return new ComputateOAuth2AuthHandlerImpl(this, updatedScopes);
  }

  @Override
  public OAuth2AuthHandler withScopes(List<String> scopes) {
    return new ComputateOAuth2AuthHandlerImpl(this, scopes);
  }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// MODIFIED BY computate FROM THE ORIGINAL vertx-web SOURCE CODE                                            //
// Commenting out this code to order the callback so that a dummy callback can be set up before the OpenAPI //
// spec is parsed and Routes are created:                                                                   //
//                                                                                                          //
//    .order(order - 1)                                                                                     //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ;
